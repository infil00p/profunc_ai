...
def pdf_to_text(pdf_path, output_txt_path, images_dir):
    """Convert a PDF to text using OCR and save the images."""
    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for file in files:
            if file.lower().endswith(".pdf"):
                ...
                # Process the PDF and save text and images
                pdf_to_text(pdf_path, output_txt_path, images_dir)
